	<div class="container border bg-light">
		...
		<div class="d-block" id="questionnaire">
			<form class="bg-gradient-warning rounded" action="traitement_inscription_part2.php" method="POST">
				<!--Genre-->
				<div class="question form-group pt-4" id="qGenre">
					<h1>Je suis: </h1>
					<div class="custom-control custom-radio">
						<input type="radio" id="qGenre_rep1" class="custom-control-input" name="qGenre" value="qGenre_rep1">
						<label for="qGenre_rep1" class="custom-control-label">Une femme</label>
					</div>
					<div class="custom-control custom-radio">
						<input type="radio" id="qGenre_rep2" class="custom-control-input" name="qGenre" value="qGenre_rep2">
						<label for="qGenre_rep2" class="custom-control-label">Un homme</label>
					</div>
				</div>
				<!-- QUESTION 1 -->
			...
			<!--Affiche questionnaire------------------------------------------------------>
			<div class="justify-content-sm-center mt-5 p-3 rounded border displayNone" id="CV">
				<h3 class="m-3 text-center">Envoie nous ton cv ou ton lien linkedIn!<br><span><a href="#BtnSubmitQuestionnaire">Passer cette étape</a></span></h3>
				<div class="custom-file m-1">
					<input type="file" class="custom-file-input" id="customFile" name="CV" accept=".pdf,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
					<label class="custom-file-label" for="customFile">Ton CV ici</label>
				</div>
			...
			<div id="BtnSubmitQuestionnaire" class=" d-flex m-5 justify-content-center displayNone" >
				<input type="submit" value="Validation" class="moreExperience justify-content-sm-center">
			</div>
		</form>
	</div>
</div>
