...
//radio
	if(!isset($q1_radio) || !isset($q3_1_vendeur_radio) ||!isset($q3_2_vendeur_radio) ||!isset($q3_1_comm_radio) ||!isset($q3_2_comm_radio) ||!isset($q6_vendeur_radio) || !isset($q8_vendeur_radio) || !isset($q9_vendeur_radio) || !isset($q3_1_hote_radio) || !isset($q1_radio) || !isset($q3_1_vendeur_radio)

$msg +="Vérifier que vous avez bien coché une réponse aux questions posées"
}

//teste condition pour chaque question
	if(!preg_match($reg_alpha_3min,$q5vendeur_textarea)){
		$erreur+=1;
	}
	if(!isset($q1_radio) || !isset($q3_2Repeat1_radio)|| !isset($q3_1_radio)){
		$erreur+=1;
	}
