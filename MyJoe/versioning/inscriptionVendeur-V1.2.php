...
<body>
	<header>
		<img class="img-fluid" src="img/image_header_quizz_vendeur-v1.4.jpg" alt="image header Joe sur ordinateur">
	</header>
	<div class="container">
		<div class="justify-content-ms-center">
					...
					<div class="form-group justify-content-sm-center m-5" id="q1_Inscription">
						...
						<span class="text-danger">
							...
							if (isset($alertMessages)) {
								if (isset($alertMessages['q1_Inscription'])) 
								{
									echo($alertMessages['q1_Inscription']);
								}
							}
							?>
						</span>
			...
			<div class="justify-content-sm-center" id="preQ">
				...
				<div class="d-flex justify-content-center m-3">
					<button class="btn btnQuestionnaire rounded" name="btn" type="submit" form="form1_inscription_vendeur" value="cestparti_vendeur">C'est parti!</button>
				</div>
				...
				<?php 
					if (isset($formDatas) && count($formDatas) > 1) 
					{
						require_once('questionnaire_Joe-V1.2.php');
					}
				?>
			
			<div class="justify-content-sm-center mt-5 p-3 rounded border displayNone" id="CV">
				<h2 class="m-3 text-center">Envoie nous ton cv ou ton lien linkedIn!<br><span><a href="#lala">Passer cette étape</a></span></h2>
			...
			<!-- <div id="lala" class="d-flex justify-content-center" >
				<button class="btn m-5 btnQuestionnaire rounded" disabled>Je valide mes informations</button>
			</div>
			<div class="d-flex justify-content-center border displayNone">
